...
import com.cinetrack.app.ui.screens.reels.ReelsScreen
import com.cinetrack.app.ui.screens.tv.TvDetailScreen
import com.cinetrack.app.ui.screens.tv.TvHomeScreen
...
sealed class Screen(val route: String, val title: String, val icon: @Composable () -> Unit) {
    ...
    data object TvHome : Screen("tv_home", "Serie TV", { Icon(Icons.Filled.LiveTv, contentDescription = "Serie TV") })  // NUOVO
    ...
    data object TvDetail : Screen("tv_detail/{tvId}", "Dettaglio Serie", {}) {   // NUOVO
        fun createRoute(tvId: Int) = "tv_detail/$tvId"
    }
    data object Reels : Screen("reels", "Reels", {})   // NUOVO
}

@Composable
fun CineTrackNavGraph() {
    val navController = androidx.navigation.compose.rememberNavController()
    val bottomBarScreens = listOf(Screen.Home, Screen.TvHome, Screen.Search, Screen.Watchlist, Screen.Settings)
    ...
    Scaffold(
        ...
        NavHost(
            ...
            // Tutte le rotte devono stare dentro queste parentesi graffe
            ...
            // Spostate qui dentro per correggere l'errore
            composable(Screen.TvHome.route) { TvHomeScreen(navController) }
            ...
            composable(
                ...
                arguments = listOf(navArgument("tvId") { type = androidx.navigation.NavType.IntType })
            ) { backStackEntry ->
                val tvId = backStackEntry.arguments?.getInt("tvId") ?: return@composable
                TvDetailScreen(tvId = tvId, navController = navController)
            }
        }
    }
}